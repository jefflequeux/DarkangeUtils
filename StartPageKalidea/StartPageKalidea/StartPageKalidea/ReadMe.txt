...
This Start Page template shows the XAML for the Visual Studio 2010 Start Page as well as how to modify the page and add a WPF UserControl.

This template is composed of two projects.
1. StartPageKalidea            - contains the loose StartPage XAML file and creates a VSIX for deployment.
2. StartPageKalideaControl     - creates a very simple WPF UserControl to add to the Start Page.
...
From the drop down, select "[Installed Extension] StartPageKalidea".
